...
public class Reservation {
	...
	// Constructors
	public Reservation(Integer id, LocalDateTime datetimeDebut, LocalDateTime datetimeFin, int nbJoueur,
			TableJeu tableJeu,
	 ...
	 * }
	 * 
	 * public void modifierResa(LocalDateTime nvlDateDebut, LocalDateTime
	 * nvlDateFin) {
	 * 
	...
	public String toString() {
		return "Reservation [id=" + id + ", datetimeDebut=" + datetimeDebut + ", datetimeFin=" + datetimeFin
				+ ", nbJoueur=" + nbJoueur + ", table=" + tableJeu.getNomTable() + ", jeu=" + jeu.getNom()
				+ ", statutReservation="
				+ statutReservation + ", client=" + client.getNom() + " " + client.getPrenom() + ", gameMaster="
				+ (gameMaster != null ? gameMaster.getNom() + " " + gameMaster.getPrenom() : "Pas de gameMaster") + "]";
	}
